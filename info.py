...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002640068354 -1002598224860 -1002406402473 -1002573533031 ').split()]  # For Multiple Id Use One Space Between Each.
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/DOWNLOADERZONEUPDATES')
